...
# try:
try:
    from flolpips.correlation import correlation_compat as correlation # the custom cost volume layer
    print("✓ Using compatibility layer for correlation")
except ImportError:
    try:
        from flolpips.correlation import correlation # the custom cost volume layer
        print("✓ Using original CuPy correlation")
    except ImportError:
        print("✗ Could not import correlation - PWCNet may not work properly")
        correlation = None
# except:
