...
class BBDMRunner(DiffusionBaseRunner):
    ...
    def sample(self, net, batch, sample_path, stage='train'):
        ...
        #
        # sample = samples[-1]
        sample = net.sample(y,z, clip_denoised=self.config.testing.clip_denoised)
    ...
    def sample_to_eval(self, net, test_loader, sample_path):
        ...
        if 'extreme' in sample_path:
            scale = 0.25
        elif 'DAVIS' in sample_path:
            scale = 0.5
        else:
            scale = 1
        ...
        for j in range(sample_num):
            ...
            for test_batch in pbar:
                ...
                for i in range(batch_size):
                    ...
                    result_prev = sample_next[i].detach()
