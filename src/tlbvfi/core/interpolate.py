...
def parse_args_and_config():
    ...
    parser.add_argument('--frame0', type=str, default="results/DAVIS/LBBDM-f32/sample_to_eval/condition/previous_frame1276.png", help='previous frame')
    parser.add_argument('--frame1', type=str, default="results/DAVIS/LBBDM-f32/sample_to_eval/condition/next_frame1276.png", help='next frame')
